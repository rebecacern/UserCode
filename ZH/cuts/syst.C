...
void syst(int cem = 8, int nsel = 1, int mh = 125, int syst = 0, bool isUp = true, int mode = 0){
  ...
  // Prepare putput file
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_cut_eee_%dTeV.root", mh, cem);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_cut_eem_%dTeV.root", mh, cem);
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_cut_emm_%dTeV.root", mh, cem);
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_cut_mmm_%dTeV.root", mh, cem);
  else sprintf(rootFile,"%d/zh3l2j_input_cut_%dTeV.root", mh, cem);
