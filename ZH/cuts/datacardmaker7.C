...
void datacardmaker7(int mh = 125, int mode = 0){
  ...
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_cut_eee_7TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_cut_eem_7TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_cut_emm_7TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_cut_mmm_7TeV.root", mh);
  else sprintf(rootFile,"%d/zh3l2j_input_cut_7TeV.root", mh);
  ...
  if (mode == 1) sprintf(datacardFile,"%d/zh3l2j_cut_eee_7TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%d/zh3l2j_cut_eem_7TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%d/zh3l2j_cut_emm_7TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%d/zh3l2j_cut_mmm_7TeV.txt", mh);
  else sprintf(datacardFile,"%d/zh3l2j_cut_7TeV.txt", mh);
