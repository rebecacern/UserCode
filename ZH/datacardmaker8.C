...
void datacardmaker8(int mh = 125, int mode = 0){
  ...
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_eee_8TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_eem_8TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_emm_8TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_mmm_8TeV.root", mh);
  else sprintf(rootFile,"%d/zh3l2j_input_8TeV.root", mh);
  ...
  if (mode == 1) sprintf(datacardFile,"%d/zh3l2j_shape_eee_8TeV.txt", mh);
  else if (mode == 2) sprintf(datacardFile,"%d/zh3l2j_shape_eem_8TeV.txt", mh );
  else if (mode == 3) sprintf(datacardFile,"%d/zh3l2j_shape_emm_8TeV.txt", mh );
  else if (mode == 4) sprintf(datacardFile,"%d/zh3l2j_shape_mmm_8TeV.txt", mh);
  else sprintf(datacardFile,"%d/zh3l2j_shape_8TeV.txt", mh);
  ...
  datacard << "shapes *   *  "  ;
  if (mode == 1){
    datacard << "zh3l2j_input_eee_8TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_eee_8TeV.root  histo_Data " << endl;
  } else if (mode == 2){
    datacard << "zh3l2j_input_eem_8TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_eem_8TeV.root  histo_Data " << endl;
  } else if (mode == 3){
    datacard << "zh3l2j_input_emm_8TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_emm_8TeV.root  histo_Data " << endl;
  } else if (mode == 4){
    datacard << "zh3l2j_input_mmm_8TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_mmm_8TeV.root  histo_Data " << endl;
  } else {
    datacard << "zh3l2j_input_8TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
