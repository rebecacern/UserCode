...
void datacardmaker7(int mh = 125, int mode = 0){
  ...
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_shape_eee_7TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_shape_eem_7TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_shape_emm_7TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_shape_mmm_7TeV.root", mh);
  else sprintf(rootFile,"%d/zh3l2j_input_shape_7TeV.root", mh);
  ...
  datacard << "shapes *   *  " ;
  if (mode == 1){
    datacard << "zh3l2j_input_shape_eee_7TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_shape_eee_7TeV.root  histo_Data " << endl;
  } else if (mode == 2){
    datacard << "zh3l2j_input_shape_eem_7TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_shape_eem_7TeV.root  histo_Data " << endl;
  } else if (mode == 3){
    datacard << "zh3l2j_input_shape_emm_7TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_shape_emm_7TeV.root  histo_Data " << endl;
  } else if (mode == 4){
    datacard << "zh3l2j_input_shape_mmm_7TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_shape_mmm_7TeV.root  histo_Data " << endl;
  } else {
    datacard << "zh3l2j_input_shape_7TeV.root  histo_$PROCESS histo_$PROCESS_$SYSTEMATIC" << endl;
    datacard << "shapes data_obs * zh3l2j_input_shape_7TeV.root  histo_Data " << endl;
  }
  datacard << "bin " ;
