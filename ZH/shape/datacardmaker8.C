...
void datacardmaker8(int mh = 125, int mode = 0){
  ...
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_shape_eee_8TeV.root", mh);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_shape_eem_8TeV.root", mh );
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_shape_emm_8TeV.root", mh );
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_shape_mmm_8TeV.root", mh);
  else sprintf(rootFile,"%d/zh3l2j_input_shape_8TeV.root", mh);
