...
void chain(int cem = 8, int nsel = 0, int mh = 125, int mode = 0){
  ...
  // Prepare output file
  char rootFile[300];
  if (mode == 1) sprintf(rootFile,"%d/zh3l2j_input_shape_eee_%dTeV.root", mh, cem);
  else if (mode == 2) sprintf(rootFile,"%d/zh3l2j_input_shape_eem_%dTeV.root", mh, cem);
  else if (mode == 3) sprintf(rootFile,"%d/zh3l2j_input_shape_emm_%dTeV.root", mh, cem);
  else if (mode == 4) sprintf(rootFile,"%d/zh3l2j_input_shape_mmm_%dTeV.root", mh, cem);
  else sprintf(rootFile,"%d/zh3l2j_input_shape_%dTeV.root", mh, cem);
